...
//                 const userCurrency = countryToCurrency[countryCode] || 'RON';
//                 setSelectedCurrency(userCurrency);
...
//                 Alert.alert('Error', 'Failed to fetch location or currency data. Defaulting to RON.');
//                 setSelectedCurrency('RON');
//             } finally {
//                 setLoading(false);
//             }
...
import React, { useState, useEffect } from 'react';
import { View, Text, Modal, TouchableOpacity, StyleSheet, Keyboard, TouchableWithoutFeedback, Alert } from 'react-native';
import { Picker } from '@react-native-picker/picker';
import * as Location from 'expo-location';
import countryToCurrency from 'country-to-currency';
